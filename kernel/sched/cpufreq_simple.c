...
static int sugov_init(struct cpufreq_policy *policy)
{
	 ...
	 */
	tunables->up_rate_limit_us = CONFIG_SIMPLE_UP_RATE_LIMIT;
	tunables->down_rate_limit_us = CONFIG_SIMPLE_DOWN_RATE_LIMIT;
...
{
	return cpufreq_register_governor(&simple_gov);
}
